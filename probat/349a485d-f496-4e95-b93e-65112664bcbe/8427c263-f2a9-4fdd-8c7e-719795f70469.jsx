...
function Home({ probat }) {
  ...
  return (
    <div className="home" style={{ backgroundColor: '#764BA2', minHeight: '100vh' }}>
      <header className="home-header" style={{ backgroundColor: '#764BA2', color: '#FFFFFF' }}>
        ...
        <div className="card">
          <button 
            style={{ backgroundColor: '#FFFFFF', color: '#764BA2', border: 'none', fontWeight: 'bold' }}
            onClick={(e) => {
              e.stopPropagation();
